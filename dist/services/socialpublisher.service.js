...
exports.publishToFacebookVideo = exports.publishToTikTokDirectPost = exports.publishToYouTube = void 0;
...
const publishToYouTube = async (accessToken, videoUrl, title, description) => {
    ...
    const response = await axios_1.default.post("https://www.googleapis.com/youtube/v3/videos?part=snippet,status", {
        snippet: {
            title,
            description,
...
const publishToFacebookVideo = async (pageToken, pageId, videoUrl, title, description) => {
    const response = await axios_1.default.post(`https://graph.facebook.com/v26.0/${pageId}/videos`, {
        file_url: videoUrl,
        title,
        description,
