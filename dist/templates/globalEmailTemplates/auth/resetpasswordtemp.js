...
exports.verifyEmailAddressMailTemplate = exports.signinMailTemplate = exports.updatedPasswordTemplate = exports.OtpTemplate = exports.resetPasswordTemplate = void 0;
const headtemplate_ts_1 = require("../headtemplate.ts");
const resetPasswordTemplate = (fullName, link) => {
    const head = (0, headtemplate_ts_1.emailHeader)();
    const foot = (0, headtemplate_ts_1.emailFooter)();
    const body = `
...
const updatedPasswordTemplate = (fullName) => {
    const head = (0, headtemplate_ts_1.emailHeader)();
    const foot = (0, headtemplate_ts_1.emailFooter)();
    const body = `
<main style="max-width: 520px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e5e5; border-radius: 12px; padding: 40px 32px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; text-align: left; box-sizing: border-box;">
...
exports.updatedPasswordTemplate = updatedPasswordTemplate;
const signinMailTemplate = (fullName) => {
    const head = (0, headtemplate_ts_1.emailHeader)();
    const foot = (0, headtemplate_ts_1.emailFooter)();
    const body = `
...
exports.signinMailTemplate = signinMailTemplate;
const verifyEmailAddressMailTemplate = (VerfificationCode) => {
    const head = (0, headtemplate_ts_1.emailHeader)();
    const foot = (0, headtemplate_ts_1.emailFooter)();
    const body = `
    <main
...
exports.verifyEmailAddressMailTemplate = verifyEmailAddressMailTemplate;
//# sourceMappingURL=resetpasswordtemp.js.map